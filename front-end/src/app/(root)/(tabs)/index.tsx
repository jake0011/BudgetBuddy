  ...
  return (
    <View className="w-full h-full bg-gray-900">
      <SafeAreaView style={SafeAreaViewAndroid.AndroidSafeArea}>
        <View className=" flex flex-row w-full h-auto bg-gray-400 justify-between">
          <Text className="p-4 text-white text-4xl justify-start">
            Hello, Edem
          </Text>
        ...
        <View className="w-full h-full mt-4">
          <TouchableOpacity className="flex flex-row text-black text-2xl items-center bg-gray-500">
            <Text className="text-black pl-4 text-xl ">Home </Text>
            <ChevronRight size="$1" />
          </TouchableOpacity>
          {/* 1st card */}
          <View className="w-full h-full mt-1 ">
            <View
              className="w-90 h-1/6 bg-gray-600 rounded-3xl p-2 m-3 overflow-hidden"
              id="card-container"
            >
            ...
            <View className="w-full mt-1  bg-gray-700">
              <TouchableOpacity className="flex flex-row text-black text-2xl items-center bg-gray-500">
                <Text className="text-black pl-4 text-xl ">Goals </Text>
                <ChevronRight size="$1" />
              </TouchableOpacity>
            </View>
            ...
            <View className="w-full mt-1  bg-gray-700">
              <TouchableOpacity className="flex flex-row text-black text-2xl items-center bg-gray-500">
                <Text className="text-black pl-4 text-xl ">Expenses Category (October) </Text>
                <ChevronRight size="$1" />
              </TouchableOpacity>
            </View>
            <View
